...
export function createInitialState() {
  return {
    ...
    miniGames: {
      treatCatch: { highScore: 0, highScoreName: null },
      dogfight: { winStreak: 0, maxWinStreak: 0, maxWinStreakName: null },
      petRun: { highScore: 0, highScoreName: null },
      slotMachine: { highScore: 0, highScoreName: null },
    },
